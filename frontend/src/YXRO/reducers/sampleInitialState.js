import { create_normalized_thickness } from './sampleReducer';
...
const normalized_thickness = create_normalized_thickness(sampleInitialState.layers);
sampleInitialState.layers = sampleInitialState.layers.map((layer, idx) => {
...
export default sampleInitialState;
